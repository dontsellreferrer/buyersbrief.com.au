...
## JWT Authentication (Local Session Auth)
...
- [x] Update useAuth hook to use JWT session auth
- [x] Remove obsolete external OAuth code paths
...
## PostgreSQL Migration (Supabase) — Independent Production Stack
...
- [x] Remove all obsolete platform API and infrastructure references from codebase

## Production Stack Cleanup — Remove Obsolete Platform References
- [x] Remove obsolete OAuth stub (server/_core/oauth.ts, registerOAuthRoutes)
- [x] Remove obsolete storage proxy (server/_core/storageProxy.ts, registerStorageProxy)
- [x] Remove obsolete platform API environment references from env.ts
- [x] Remove obsolete platform storage asset references from components
- [x] Audit codebase for obsolete platform and OAuth references


## Multi-Step Signup Flow with Stripe Integration
- [ ] Set up Stripe integration via standard implementation workflow
